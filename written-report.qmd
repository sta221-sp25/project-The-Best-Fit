...
p1 <- ggplot(newsdf, aes(x = title_sentiment_polarity)) +
  geom_histogram(fill = "blue", color = "black", alpha = 0.7) +
   labs(title = "Distribution of Title Sentiment",
...
p2 <- ggplot(newsdf, aes(x = global_subjectivity)) +
  geom_histogram(fill = "blue", color = "black", alpha = 0.7) +
   labs(title = "Distribution of Article Subjectivity",
...
p4 <- ggplot(newsdf, aes(x = log(kw_avg_avg))) +  
  geom_histogram(fill = "purple", color = "black", alpha = 0.7) +
  labs(title = "Dist. of Keyword Popularity (Log-Trans.)",
       x = "Keyword Popularity (Log-Trans.)",
       y = "Count of Articles") +
  theme_minimal()
