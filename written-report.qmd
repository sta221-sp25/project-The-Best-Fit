...
#| label: vis-interact-effects 
 ...
 interactData <- ggplot(newsdf, aes(fill=factor(is_viral), y=global_subjectivity)) + 
 ...
 interactContent <- ggplot(newsdf, aes(fill=factor(is_viral), y=log(n_tokens_content))) + 
