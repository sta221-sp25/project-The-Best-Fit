...
$$
All the predictors in our initialky fit model possess significant p-values (p\<0.05) and most predictors have relatively high magnitude z-statistics, indicating that all variables in the model have statistically significant relationships with the likelihood of content going viral (re: fig 4, appendix). 
...
Selecting the point closest to the ROC curve to sensitivity 0.65 yields a threshold of approximately 0.493, to be used when evaluating the final model (re: fig 5, appendix).
